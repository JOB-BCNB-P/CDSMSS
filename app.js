...
async function handleLogin(e) {
  ...
  // ถ้ายังไม่ได้โหลดข้อมูลจากชีต ให้โหลดก่อน 1 รอบ
  ...
  const user  = users.find(u => {
    ...
    const activeFlag = String(u.active).toLowerCase();
    const isActive = !activeFlag || activeFlag === 'true';
    return uEmail === email && uPass === password && isActive;
  });
